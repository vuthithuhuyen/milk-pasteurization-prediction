...
from Controller.MainWindowController import Selected_Row2DF, TabelViewClick, TrainClick, DisplayPlot, PredictRegidClick, \
    LoadModelClick, PredictFlexibleClick, AutoGenerateParameters
...
class MainWindowClass(QMainWindow):
    def __init__(self):
        try:
            ...
            InitialComboxState(self.cmbMixA_State)
            InitialComboxState(self.cmbMixB_State)
            ...
            # Display plot data:
            DisplayPlot(df, 3, self.lbl_image1, '#214dad')
            DisplayPlot(df, 4, self.lbl_image2, '#fc6203')
